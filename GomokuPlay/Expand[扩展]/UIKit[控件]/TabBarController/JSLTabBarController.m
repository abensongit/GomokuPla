...
@interface JSLTabBarController () <UITabBarControllerDelegate>

@end

@implementation JSLTabBarController
...
tabBarItemEnabled:(BOOL)enabled
{
    ...
    if (enabled) {
        ...
        // 标签栏图标
        CGSize imageSize = CGSizeMake(TAB_BAR_HEIGHT*0.44, TAB_BAR_HEIGHT*0.44);
        ...
        naviViewController.tabBarItem.selectedImage = [[[[UIImage imageNamed:selectImageName] imageWithTintColor:COLOR_TAB_BAR_TITLE_SELECT_DEFAULT]
                                                        imageByScalingProportionallyToSize:imageSize]
                                                       imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    } else {
