...
@protocol JSLBaseCoreViewControllerInterfaceOrientationProtocol <NSObject>
@required
...
@interface JSLBaseCoreViewController : JSLNetworkViewController <JSLBaseCoreViewControllerInterfaceOrientationProtocol>
