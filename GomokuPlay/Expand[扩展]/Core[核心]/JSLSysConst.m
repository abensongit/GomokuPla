...
@implementation JSLSysConst

#pragma mark 控件间隔常量
CGFloat const MARGIN = 10.0f;

#pragma mark 最小浮点常量
CGFloat const NEX_FLOAT_MIN = CGFLOAT_MIN;

#pragma mark 标签栏高度(系统默认高度为49)
CGFloat const TAB_BAR_HEIGHT = 49.0f;

#pragma mark 标签栏高度 - 危险区域
CGFloat const TAB_BAR_DANGER_HEIGHT = 34.0f;

#pragma mark 状态栏+导航条容器TAG值
CGFloat const STATUS_NAVIGATION_BAR_TAG = 888888.0f;
...
CGFloat const NAVIGATION_BAR_HAIR_LINE_HEIGHT_DEFAULT = 1.0f;
...
CGFloat const SEPARATOR_LINE_HEIGHT = 1.0f;
