...
#import "JSLStringMathsUtil.h"

@implementation JSLStringMathsUtil
...
{
    return [JSLStringMathsUtil validatePureInt:value] || [JSLStringMathsUtil validatePureFloat:value];
}
