...
CGFloat        const CCZSpreadDis = 60; // 默认弹出距离
...
{
    _duration = .12;
    _style = JSLAssistiveTouchStylePop;
    ...
    _selectBackgroundColor = [UIColor darkGrayColor];
}
